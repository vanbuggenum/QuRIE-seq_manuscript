...
```{r Figure_1_supplementary, fig.width=5.6, fig.height=6.69, message = FALSE, warning=FALSE}
...
Fig1.pca
```
*Supplementary Figure.* PCA analysis on RNA ór Protein dataset
...
ggsave(Suppl_mofa, filename = "output/paper_figures/Fig2.Suppl_MOFAaIg.pdf", width = 183, height = 220, units = "mm",  dpi = 300)
