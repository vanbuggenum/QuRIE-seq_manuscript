...
plot_percent.mt <- plot_QC_paper(seu_object = seu_combined, 
                                 ...
                                 xtext = "Time aIg stimulation (minutes)",
                                 paneltitle = "Keep cells < 15 % and samples < median 11 % mitochondrial",
                                 colorviolin = "dodgerblue2" ) +
                        geom_hline(yintercept = 11, size = 0.3) +
...
Based on the indicated cut-offs, high-quality cellsare filtered for further analysis. 
Based on the good protein quality of samples and m<11% median mitochondiral counts per sample, timepoints 0, 2, 4, 6, 60 and 180 are kept for further analysis.
